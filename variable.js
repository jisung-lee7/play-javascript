 ...
 * Hoisting - move declaration from bottom to top anywhere within the scope(Only declaration, NOT assignments)
              'let' and 'constant' are also hoisted, but they cause an error because TDZ(Temporal Dead Zone).
              It can't use before assignments.
*/
console.log(`\n[ Variable ]`)
...
showAge() // it would have displayed 30
